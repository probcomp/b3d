...
optimizer_vertices = optax.adam(learning_rate=1)
vertices = initial_mesh[0]
...
obs, weights, atts = trace.get_retval()
r, w, a = obs[0], weights[0], atts[0]
likelihood.logpdf(r, w, a)

trace.project(key, genjax.select("face_colors"))