...
def model_factory(
    ...
    def generate_frame(camera_pose, vertices, faces, face_colors):
        ...
        v, f, vc = b3d.utils.triangle_color_mesh_to_vertex_color_mesh(vertices_W, faces, face_colors)
    ...
    def model():
        ...
        camera_poses = genjax.map_combinator(
            in_axes=(0, 0)
        )(uniform_pose)(jnp.ones((n_frames, 3)) * -100., jnp.ones((n_frames, 3)) * 100.) @ "camera_poses"
