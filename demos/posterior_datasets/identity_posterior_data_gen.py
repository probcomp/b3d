...
rr.log(
    ...
    rr.Mesh3D(
        ...
        triangle_indices=object_library.faces[
            object_library.ranges[0, 0] : object_library.ranges[0, :].sum()
        ],
...
rr.log(
    ...
    rr.Mesh3D(
        ...
        triangle_indices=object_library.faces[
            object_library.ranges[1, 0] : object_library.ranges[1, :].sum()
        ],
        vertex_colors=object_library.attributes,
    ),
)
...
rgbs_knife, depths_knife = renderer.render_attribute_many(
    scene_poses_in_camera,
    object_library.vertices,
    object_library.faces,
