...
def gausssian_mixture_vectorize_old(
    ...
    return {'pix_score': jnp.logaddexp(inlier_score, outlier_score),
...
def kray_likelihood_intermediate(observed_rgbd, rendered_rgbd, likelihood_args):

    (inliers, color_inliers, depth_inliers, teleport_outliers, nonteleport_outliers, valid_data_mask) = get_rgb_depth_inliers_from_observed_rendered_args(
        observed_rgbd[...,:3],
        rendered_rgbd[...,:3],
        observed_rgbd[...,3],
        rendered_rgbd[...,3],
    ...
    final_score_per_pix =  inlier_contribution + outlier_contribution_teleporation + outlier_contribution_not_teleportation
