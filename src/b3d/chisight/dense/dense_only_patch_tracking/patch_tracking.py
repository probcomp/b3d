...
<<<<<<< HEAD:b3d/chisight/dense/dense_only_patch_tracking/patch_tracking.py
...
>>>>>>> main:src/b3d/chisight/dense/dense_only_patch_tracking/patch_tracking.py
...
def get_adam_optimization_patch_tracker(
    ...
    def importance_from_pos_quat(positions, quaternions, observed_rgbd):
        ...
        trace, weight = model.importance(
            key, cm, (patch_vertices_P, patch_faces, patch_vertex_colors)
        )
        return trace, weight
