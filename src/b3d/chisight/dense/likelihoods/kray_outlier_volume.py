<<<<<<< HEAD:b3d/chisight/dense/likelihoods/kray_outlier_volume.py
import genjax
from genjax.generative_functions.distributions import ExactDensity
=======
>>>>>>> main:src/b3d/chisight/dense/likelihoods/kray_outlier_volume.py
...
def kray_likelihood_intermediate(observed_rgbd, scene_mesh, renderer, likelihood_args):
    ...
    V = (
        1
        / 3
        * jnp.power(renderer.far, 3)
        * renderer.width
        * renderer.height
        * 1
        / (fx * fy)
    )
    outlier_contribution_teleporation = jnp.sum(
        outliers
        * observed_areas
        / V
        * 0.001
    ...
    outlier_contribution_not_teleportation = jnp.sum(
        outliers
        * observed_areas
        / V
        * outlier_prob
