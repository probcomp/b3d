...
from warp.sim.collide import closest_point_plane, limited_counter_increment, counter_increment
...
class Model:
    ...
    def __init__(self, 
        ...
        self._ka = ka
        self._mu = mu
        self._body_count = len(self._body_mass)

    def clear_old_count(self):
        if self._shape_contact_pair_count or self._ground and self._shape_ground_contact_pair_count:
            # clear old count
...
def collide(
    ...
    rigid_contact_point_limit: wp.array(dtype=wp.int32),
    ...
    rigid_contact_pairwise_counter: wp.array(dtype=wp.int32),
...
jax_collide = jax_callable(collide, num_outputs=15)
...
def step(model, state, dt):
    ...
    shape_contact_pair_count, ground, shape_ground_contact_pair_count, rigid_contact_count, rigid_contact_broad_shape0, rigid_contact_broad_shape1, shape_contact_pairs, shape_transform, shape_body, body_mass, shape_count, geo_type, geo_scale, geo_source, geo_thickness, shape_collision_radius, rigid_contact_max, rigid_contact_margin, rigid_mesh_contact_max, rigid_contact_point_id, rigid_contact_point_limit, shape_ground_contact_pairs, rigid_contact_tids, rigid_contact_pairwise_counter, rigid_contact_shape0, rigid_contact_shape1, rigid_contact_point0, rigid_contact_point1, rigid_contact_offset0, rigid_contact_offset1, rigid_contact_normal, rigid_contact_thickness, body_com, body_inertia, body_inv_mass, body_inv_inertia, gravity, ke, kd, kf, ka, mu, body_count = model_attributes.values()
    ...
    rigid_contact_pairwise_counter: wp.array(dtype=wp.int32),
    rigid_contact_tids: wp.array(dtype=wp.int32)
    output_dims_coll = {"c": a.shape}
    rigid_contact_count, rigid_contact_broad_shape0, rigid_contact_broad_shape1, rigid_contact_point_id, rigid_contact_point_limit, rigid_contact_shape0, rigid_contact_shape1, rigid_contact_point0, rigid_contact_point1, rigid_contact_offset0, rigid_contact_offset1, rigid_contact_normal, rigid_contact_thickness, rigid_contact_pairwise_counter, rigid_contact_tids = jax_collide(shape_contact_pair_count, shape_contact_pairs, body_q, shape_transform, shape_body, body_mass, shape_count, geo_type, geo_scale, geo_source, geo_thickness, shape_collision_radius, rigid_contact_max, rigid_contact_margin, rigid_mesh_contact_max, ground, shape_ground_contact_pair_count, shape_ground_contact_pairs, output_dims=output_dims_coll)
    ...
    model.update_attributes(_rigid_contact_count = rigid_contact_count, _rigid_contact_broad_shape0 = rigid_contact_broad_shape0, _rigid_contact_broad_shape1 = rigid_contact_broad_shape1, _rigid_contact_point_id = rigid_contact_point_id, _rigid_contact_point_limit = rigid_contact_point_limit, _rigid_contact_shape0 = rigid_contact_shape0, _rigid_contact_shape1 = rigid_contact_shape1, _rigid_contact_point0 = rigid_contact_point0, _rigid_contact_point1 = rigid_contact_point1, _rigid_contact_offset0 = rigid_contact_offset0, _rigid_contact_offset1 = rigid_contact_offset1, _rigid_contact_normal = rigid_contact_normal, _rigid_contact_thickness = rigid_contact_thickness, _rigid_contact_pairwise_counter = rigid_contact_pairwise_counter, _rigid_contact_tids = rigid_contact_tids)
