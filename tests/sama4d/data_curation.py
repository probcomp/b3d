...
def get_loaders_for_curated_unity_scenes():
    return [{
        ...
        "feature_track_data_loader": (lambda: feature_track_data_from_scene_spec(spec))
...
def get_cheezitbox_scene_loader(n_frames=30):
    return {
        ...
        "feature_track_data_loader": (lambda: ftd_from_rotating_cheezit_box(n_frames=n_frames))
    }
